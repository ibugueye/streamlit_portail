...
page = st.sidebar.radio("Aller à :", ["🏠 À propos", "💻 Applications", "🌍 Afrique", "📝 Publications", "📬 Contact"])
...
# --- PAGE 4 : PUBLICATIONS MEDIUM ---
    ...
    <div style='text-align: center; margin-top: 30px;'>
        <a href="https://medium.com/@ibrahimagueye" target="_blank">
            <button style='
                background-color: #00ab6c; 
                color: white; 
                border: none; 
...
# --- PAGE 5 : CONTACT ---
    ...
    with col1:
        ...
        **📝 Medium :** [medium.com/@ibrahimagueye](https://medium.com/@ibugueye)  
...
with st.sidebar:
    ...
    **Medium:** [@ibrahimagueye](https://medium.com/@ibrahimagueye)
    """)
